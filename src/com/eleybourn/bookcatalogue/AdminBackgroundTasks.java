 ...
 */
public class AdminBackgroundTasks extends BindableItemListActivity {
    /**
     * Listener to handle Event add/change/delete.
     */
    private final OnTaskChangeListener m_OnTaskChangeListener = (task, action) -> AdminBackgroundTasks.this.refreshData();
    ...
    public AdminBackgroundTasks() {
        super(R.layout.admin_background_tasks);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        try {
            ...
            setContentView(R.layout.admin_background_tasks);
            ...
            // Bind the 'cleanup' button.
            {
                ...
                v.setOnClickListener(v1 -> QueueManager.getQueueManager().cleanupOldTasks(7));
            }
    ...
    public void onListItemClick(AdapterView<?> parent, final View v, final int position, final long id) {
        ...
        items.add(new ContextDialogItem(getString(R.string.show_events_ellipsis), () -> doShowTaskEvents(id)));
    ...
    private void doShowTaskEvents(long taskId) {
        AdminBackgroundEvents.start(this, taskId);
    }
