 ...
 */
public class AdminFieldVisibility extends BookCatalogueActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        try {
            ...
            setContentView(R.layout.admin_field_visibility);
            MaterialToolbar topAppBar = findViewById(R.id.topAppBar);
            setSupportActionBar(topAppBar);
            topAppBar.setTitle(R.string.title_manage_fields);
    ...
    public void setupFields() {
        ...
        int[] fieldRs = {R.string.label_author, R.string.label_title, R.string.label_thumbnail, R.string.label_isbn, R.string.label_series, R.string.label_series_number,
                R.string.label_publisher, R.string.label_date_published, R.string.label_bookshelf, R.string.label_pages, R.string.label_list_price,
                R.string.label_read, R.string.label_rating, R.string.label_notes, R.string.label_anthology, R.string.label_location_of_book,
        ...
        for (int i = 0; i < fields.length; i++) {
            ...
            OnClickListener listener = v -> {
                SharedPreferences mPrefs1 = getSharedPreferences("bookCatalogue", MODE_PRIVATE);
            ...
            cb.setTextAppearance(R.style.layout_title);
