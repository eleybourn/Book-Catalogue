...
public class BcService {
    ...
    // TODO Remove suppression for SDK>33
        ...
        while (keysIterator.hasNext()) {
            ...
            switch (key) {
                ...
                case LANGUAGE:
                    ...
                    break;
                case ANTHOLOGY:
                    addIfNotPresent(bookData, CatalogueDBAdapter.KEY_ANTHOLOGY_MASK, value);
                    break;
                case GENRE:
                ...
                case AUTHORS: {
                    ...
                    for (int aIdx = 0; aIdx < authorsJson.length(); aIdx++) {
                        ...
                        String name;
                        try {
                            name = authorJson.getString(FULL_NAME);
                        } catch (JSONException e) {
                            name = authorJson.getString(FAMILY_NAME) + ", " + authorJson.getString(GIVEN_NAMES);
                        }
                        //int pos = Integer.parseInt(authorJson.getString(AUTHOR_POSITION));
                        authors[pos] = name;
                        pos++;
                    }
