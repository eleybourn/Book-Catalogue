 ...
 */
public class LibraryGroup implements Serializable {
	 ...
	 */
	public static ArrayList<LibraryGroup> getAllGroups() {
		ArrayList<LibraryGroup> list = new ArrayList<>();
	...
	/**
	 * Create a new LibraryGroup of the specified kind, creating any more specific subclasses as necessary.
	 * 
	 * @param kind		Kind of group to create
	 */
	public static LibraryGroup newGroup(int kind) {
		LibraryGroup g;
		switch(kind) {
		case ROW_KIND_AUTHOR:
			g = new LibraryGroup.BooklistAuthorGroup();
			break;
		case ROW_KIND_SERIES:
			g = new LibraryGroup.BooklistSeriesGroup();
			break;
		default:
			g = new LibraryGroup(kind);
			break;			
		}
		return g;
	}
	...
	/**
	 * Specialized LibraryGroup representing an Author group. Includes extra attributes based
	 * on preferences.
	 * 
	 * @author Philip Warner
	 */
	public static class BooklistSeriesGroup extends LibraryGroup /* implements Parcelable */ {
	 ...
	 * @author Philip Warner
	 */
	public static class BooklistAuthorGroup extends LibraryGroup {
