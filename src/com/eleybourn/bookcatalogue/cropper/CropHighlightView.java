...
class CropHighlightView {
    ...
    private void init() {
        ...
        mResizeDrawableWidth =
                resources.getDrawable(R.drawable.crop_camera_crop_width);
        mResizeDrawableHeight =
                resources.getDrawable(R.drawable.crop_camera_crop_height);
        mResizeDrawableDiagonal =
                resources.getDrawable(R.drawable.crop_indicator_autocrop);
    }
